...
import PageUserPermissionsTable from './PageUserPermissionsTable';
...
function PageSettings({
  ...
  if (
    ...
    if (showSettings) {
      return (
        <>
          <div className="mobile-page-settings">
            <button
            ...
            selectedPage != undefined ? (
              <>
                <h3 className="mobile-page-settings">Page Settings</h3>
                <br></br>
                <PageDetailsEditor
