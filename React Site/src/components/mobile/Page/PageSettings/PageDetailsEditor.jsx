    ...
    if (editing) {
      return (
        <>
          <div className="mobile-settings-section">
            <br></br>
            <h3 className="mobile-section-title">Edit Page Details</h3>
            <br></br>
            <div className="mobile-edit-window">
              ...
              <div className="mobile-edit-page-details">
                ...
                <p>Published</p>
                <input
                  className="mobile-edit-published"
                  style={{ background: '#FFE5E5' }}
                  type="checkbox"
                  name="published"
                  required
      ...
      return (
        <>
          <div className="mobile-settings-section">
            <br></br>
            <h3 className="mobile-section-title">Page Details</h3>
            <br></br>
            <div className="mobile-page-details">
              <p>
            ...
            <div className="mobile-page-details-edit-or-delete">
              <button
                className="mobile-edit-page-details"
