...
function PageList({ APIAdress, token, sessionUser, switchComponent, getPage }) {
  ...
  if (pages.length > 0 && pageCreators.length > 0) {
    return (
      <>
        <div className="mobile-pages">
          <h1 className="mobile-pages-title">Pages</h1>
          <p className="mobile-pages-p">
          ...
          <br></br>
          <div className="mobile-page-list-actions">
            {sessionUser.user_type_id <= 3 ? (
              <>
                <button
                  className="mobile-new-page"
            ...
            <div className="mobile-pages-filter">
              <select
                className="mobile-pages-creator-filter"
                value={sc}
          ...
          <div className="mobile-pages-list">
            {pages.length > 1 ? (
              <>
                <p className="mobile-page-results">
            ...
            {totalSections > 1 ? (
              <>
                <p className="mobile-page-section">
                  {' '}
            ...
            {totalSections > 1 ? (
              <>
                <div className="mobile-page-section-select">
                  {Array.from({ length: totalSections }, (_, i) => (
                    <button
                      key={i + 1}
                      onClick={() => handlePageChange(i + 1)}
                      className="mobile-page-section-select"
                    >
                      {i + 1}
                    </button>
                  ))}
    ...
    return (
      <>
        <div className="mobile-pages">
          <h1 className="mobile-pages-title">No Pages Found</h1>
          <p className="mobile-page-error">{error}</p>
          <button
            className="mobile-new-page"
            onClick={() => switchComponent(1)}
          ...
          <p>
            No pages found, none may exist or you may not have permission to
            view any.
          </p>
        </div>
      </>
