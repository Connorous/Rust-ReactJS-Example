  ...
  return (
    <>
      <div className="mobile-new-page">
        <h2 className="mobile-new-page">Create New Page</h2>
        <br></br>
        <div>
          <h3 className="mobile-new-page">Page Title</h3>
          <p className="mobile-new-page">
            Enter a page title below to create your own page.
          </p>
        ...
        <div className="new-page-save-or-discard">
          <button
            className="mobile-new-page-discard "
            onClick={() => {
              discard();
            }}
          >
          ...
          <button
            className="mobile-new-page-save"
            onClick={() => {
              newPage();
            }}
          >
