...
function Page({
  ...
  useEffect(() => {
    setPageClassName('mobile-creator_page' + selectedPage.id);
  }, [pageCss]);
  ...
  if (userPermissions != null) {
    return (
      <>
        <div ref={childDiv}>
          <div className="mobile-page-top-section">
            <div className="mobile-page-top-actions">
              <button className="mobile-refresh" onClick={() => refreshPage()}>
                <svg
                  width="24px"
                  height="24px"
                  viewBox="0 0 24 24"
            ...
            {editing === false ? (
              <>
                ...
                userPermissions.permission_type_id <= 2 ? (
                  <>
                    <button
                      className="mobile-edit-elements"
          ...
          <div className={pageClassName}>
            <div
              style={{
                flexGrow: '2',
                height: '100%',
                paddingBottom: '146.23%',
              }}
            >
              <div>
                <p className="mobile-error">{error}</p>
                <div className="mobile-page-content">
                  <h2 style={{ textAlign: 'center' }} className={pageClassName}>
                    {selectedPage.title}
                  </h2>

                  <p className="mobile-page-createdby">
