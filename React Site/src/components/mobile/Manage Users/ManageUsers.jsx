...
function ManageUsers({ APIAdress, token, sessionUser }) {
  ...
  if (
    ...
    return (
      <>
        <div className="mobile-manage-users">
          <br></br>
          <br></br>
          <h1 className="mobile-manage-user-title">Manage Users</h1>
          <p className="mobile-manage-users-error">{error}</p>
          {loading === true ? (
            <>
              <h3 className="mobile-manage-users-loading">Loading</h3>
            </>
          ) : (
            <>
              {showResponseMsg ? (
    ...
    return (
      <>
        <div className="mobile-manage-users">
          <h1 className="mobile-manage-users-title">Manage Users</h1>
