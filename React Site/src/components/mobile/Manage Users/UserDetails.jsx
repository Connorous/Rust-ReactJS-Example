...
function UserDetails({
  ...
  return (
    <>
      {editing ? (
        <>
          <h2 className="mobile-manage-user-title">
      ...
      {editing ? (
        <>
          <div>
            <div className="mobile-manage-users-user-details">
              <p>Username</p>
            ...
            <br></br>
            <br></br>
            <div className="mobile-manage-users-edit-or-delete">
              <button
                className="mobile-manage-users-discard"
                onClick={() => {
                  discard();
                }}
              >
              ...
              <button
                className="mobile-manage-users-save"
                onClick={() => {
                  updateUser();
                }}
              >
        ...
        <>
          <p className="mobile-manage-users-error">{error}</p>
          <div className="mobile-manage-users-user-details">
            <p>Name</p>
          ...
          <div className="mobile-manage-users-edit-or-delete">
            <button
              className="mobile-manage-users-edit"
            ...
            <button
              className="mobile-manage-users-del"
              onClick={() => deleteUser()}
            >
              <svg
                width="800px"
          ...
          <br></br>
          <button
            className="mobile-manage-users-back"
            onClick={() => {
              switchComponent(0);
            }}
          >
