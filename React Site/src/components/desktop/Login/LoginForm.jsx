        ...
        <>
          <div className="login-page">
            ...
            <div className="login-form">
              <h1 className="login-title">Login to Page Creator</h1>
              <p className="login-inform">
              ...
              <br></br>
              <button className="login-switch" onClick={() => changeRegLog(1)}>
                Register
              </button>
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              <a className="login-inform" onClick={() => changeRegLog(2)}>
        ...
        <>
          <div className="login-page">
            ...
            <div className="login-form">
              ...
              <br></br>
              <button className="login-switch" onClick={() => changeRegLog(0)}>
                Log in
              </button>
              <br></br>
              <br></br>
        ...
        <>
          <div className="login-page">
            ...
            <div className="login-form">
              ...
              <br></br>
              <p className="login-error">{error}</p>
              <button className="login-submit" onClick={() => resetPassword()}>
                Reset Password
              </button>
              <br></br>
              <br></br>
