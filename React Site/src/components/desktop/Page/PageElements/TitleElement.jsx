function TitlePageElement({
  ...
  if (editing) {
    return (
      <>
        <div className="page-element-editing">
          <div className="elements-editor">
            <div className="elements-inputs">
              <select
                className="elements-change-type"
                value={et}
    ...
    return (
      <>
        <h3 className={cssClassName}>{content}</h3>
      </>
    );
  }
}

export default TitlePageElement;
