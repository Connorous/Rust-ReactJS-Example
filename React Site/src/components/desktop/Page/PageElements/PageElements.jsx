  ...
  if (editing) {
    return (
      <>
        <div>
          <br></br>
          <p className="elements-error">{error}</p>
          <div className="elements-save-or-discard">
            <button className="elements-save" onClick={() => save()}>
              Save
            </button>
            <button className="elements-discard" onClick={() => discard()}>
              Discard
            </button>
          </div>
          <br></br>
          <br></br>
          <div className="editing-page-elements">
          ...
          <br></br>
          <button className="elements-add" onClick={() => newPageElement(null)}>
            +
          </button>
          <br></br>
          <br></br>
