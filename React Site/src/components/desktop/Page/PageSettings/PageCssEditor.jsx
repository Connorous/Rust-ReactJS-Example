    ...
    if (editing) {
        ...
        <>
          <div className="settings-section">
            <div className="edit-window">
              <br></br>
              <h3 className="section-title">Page CSS</h3>
              <br></br>
              ...
              text-align: backwards;
                  ...
                  {cssSheetId != 'None' ? (
                    <>
                      ...
                      <br></br>
                      <p className="tip">
                        Please write Css with .{pageClassName} after any element
                        type, for example "div.{pageClassName} {'{'}
                        text-align: center; color: black;
                        {'}'}" or even "a.{pageClassName} {'{'}color: blue;
                        {'}'}".
                        <br></br>
                        for videos div.{pageClassName}-video is required instead
                        for, example div.{pageClassName}-video {'{'}
                        width
                        {':'} {'50%; }'}.<br></br>
              ...
              <div>
                <button className="settings-add" onClick={() => switchToAdd()}>
                  +
                </button>
              </div>
              <br></br>
      ...
      return (
        <>
          <div className="settings-section">
            <br></br>
            <h3 className="section-title">New Page CSS</h3>
            <br></br>
            <div className="edit-window">
              <p className="settings-error">{error}</p>
              <div className="edit-page-details">
              ...
              <div className="update-or-delete">
                <div className="page-details-save-or-discard">
                  <button className="settings-save" onClick={() => newCSS()}>
                    Save
                  </button>
                  <button
